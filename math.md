...
1. $\sin(\arccos x)=\sqrt(1-x^2) x\in[-1,1]$
1. $\cos(\arccos x)=x x\in[-1,1]$
1. $\cos(\arcsin x)=\sqrt(1-x^2) x\in[-1,1]$
1. $\arcsin(\sin x)=x x\in[-{2\over \pi},{2\over \pi}]$
1. $\arccos(\cos x)=x x\in[-{2\over \pi},{2\over \pi}]$
...
1. $x-\sin x = {1\over 6}x^3$
1. $\arcsin x - x = {1\over6}x^3$
1. $\tan x - x = {1\over 3}x^3$
1. $\tan x-\sin x = {1\over 2}x^3$
1. $x-\arctan x = {1\over 3}x^3$
3. $x\rightarrow 0 时，\ln{(x+\sqrt{x^2+1})}\sim x$
1. 若$\lim u^v为1^\infty型，则\lim u^v=e^{\lim (u-1)v}$
4. 常见奇函数:
    $
    y=\ln(x+\sqrt{x^2+1})\\
    y=e^x-e^{-x}
...
1. $若\lim f(x)存在，且n为正整数，则\lim[f(x)]^n=[\lim f(x)]^n$
...
1. $\lim\limits_{n\rightarrow \infty}a_n=a \Leftrightarrow \lim\limits_{k\rightarrow \infty}a_{2k}=\lim\limits_{k\rightarrow \infty}a_{2k-1}=a$
1. $\lim\limits_{n\rightarrow \infty}a_n=A \Rightarrow \lim\limits_{n\rightarrow \infty}|a_n|=|A|$
1. $\lim\limits_{n\rightarrow \infty}|a_n|=0 \Rightarrow \lim\limits_{n\rightarrow \infty}a_n=0$
...
1. 复合函数的奇偶性$
    ...
    \end{matrix}\right.
    $
2. $f(x+y)=f(x)+f(y)\Rightarrow f(x)是奇函数$
3. $若f(x)以T为周期，则f(ax+b)以{T\over |a|}为周期$
4. $若g(x)是周期函数，则f[g(x)]也是周期函数$
5. $若f(x)可导且以T为周期，则f^\prime(x)也以T为周期$
6. $\left.\begin{matrix}
    f(x)连续\\
    f(x)以T为周期\\
    \int_0^Tf(t)dt=0\\
...
# 导数与微分
## 公式
3. $[\ln{(x+\sqrt{x^2+1})}]^\prime = {1\over \sqrt{x^2+1}}$
